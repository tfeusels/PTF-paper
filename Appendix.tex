...
\begin{figure}[htbp]
  \begin{center}
    \subfloat[Magnetic field magnitude and vector field\label{fig:bfield_fullcomp_vec}]{
      \includegraphics[width=0.6\textwidth]{bfield_full_compensation_z400_vec.pdf}
    }
    \subfloat[X-component of magnetic field\label{fig:bfield_fullcomp_x}]{
      \includegraphics[width=0.6\textwidth]{bfield_full_compensation_z400_x.pdf}
    }\\
    \vspace{-3 mm}
    \subfloat[Y-component of magnetic field\label{fig:bfield_fullcomp_y}]{
      \includegraphics[width=0.6\textwidth]{bfield_full_compensation_z400_y.pdf}
    }
    \subfloat[Z-component of magnetic field\label{fig:bfield_fullcomp_z}]{
      \includegraphics[width=0.6\textwidth]{bfield_full_compensation_z400_z.pdf}
    }
