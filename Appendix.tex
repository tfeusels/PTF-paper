...
\begin{figure}[htbp]
  ...
  \caption{Plots of magnetic field with an offset of 50 mG in the x-direction; the magnetic fields are mapped in the x-y plane at the height of the center of the electron path trajectory.}
...
\begin{figure}[htbp]
  ...
  \caption{Plots of magnetic field with an offset of 150 mG in the y-direction; the magnetic fields are mapped in the x-y plane at the height of the center of the electron path trajectory.}
...
\begin{figure}[htbp]
  ...
  \caption{Plots of magnetic field with an offset of -100 mG in the z-direction; the magnetic fields are mapped in the x-y plane at the height of the center of the electron path trajectory.}
