...
Figure~\ref{fig:bfield_2gironeffects} shows that adding a second layer of GIRON flooring does not reduce the gradient in the magnetic field. Therefore a third layer was not added.
%
\begin{figure}[htbp]
  \begin{center}
  \includegraphics[width=0.48\textwidth]{bfield_0_no_compensation_z_clrbaredit.pdf} 
  \includegraphics[width=0.48\textwidth]{bfield_1_1layerGIRON_coilsOff_z_clrbaredit.pdf}
