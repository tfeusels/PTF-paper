...
The magnetic fields exhibit large gradients in each direction. The GIRON magnetic shielding helps reduce these gradients to make the magnetic field in each cross-sectional plane of the PTF more uniform.
%
\begin{figure}[htbp]
  \begin{center}
  \begin{tabular}{c c}
  \includegraphics[width=0.45\textwidth]{bfield_0_no_compensation_vec.pdf}
  \includegraphics[width=0.45\textwidth]{bfield_0_no_compensation_x.pdf} \\
  \includegraphics[width=0.45\textwidth]{bfield_0_no_compensation_y.pdf}
  \includegraphics[width=0.45\textwidth]{bfield_0_no_compensation_z.pdf} \\
  \end{tabular}
  \caption{Magnetic field conditions in the photosensor test facility (PTF) during cyclotron shutdown period, with no compensation}
