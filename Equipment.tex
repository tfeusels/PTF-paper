...
The PTF is located a few hundred meters away from TRIUMF's cyclotron, which produces a magnetic field of around 1800 mG in magnitude in the PTF when turned on (Jaffray, 2016 - PTF Reference Manual). Even when the cyclotron is turned off, surrounding structural material in the building can be magnetized and affect the magnetic fields in the PTF.
...
The magnetic fields exhibit large gradients in each direction. The GIRON magnetic shielding helps reduce these gradients to make the magnetic field in each cross-sectional plane of the PTF more uniform. Figure~\ref{fig:bfield_1gironeffects} shows how the gradient observed in z-component of the magnetic field in the PTF is reduced by $ 64\pm7\% $ by adding one layer of GIRON flooring (see~\ref{appendix} for calculations).
Figure~\ref{fig':bfield_2gironeffects} shows that adding a second layer of GIRON flooring only reduces the gradient by an additional $ 1\pm1\% $ compared to the single layer flooring. The uniformity of the magnetic field did not seem to improve by the added GIRON flooring, so a third layer was not added.
%
\begin{figure}[htbp]
  \begin{center}
  \includegraphics[width=0.5\textwidth]{bfield_0_no_compensation_z_cbaredit.pdf} 
  \includegraphics[width=0.5\textwidth]{bfield_1_1layerGIRON_coilsOff_z_cbaredit.pdf}
  \caption{The z-component of the magnetic field with no GIRON flooring (left) and with one layer of GIRON flooring (right). The circle outlines the position of the 20-inch PMT when it is being measured in the PTF.}
  \label{fig:bfield_1gironeffects}
  \end{center}
\end{figure}
%
\begin{figure}[htbp]
  \begin{center}
  \includegraphics[width=0.5\textwidth]{bfield_2_2layerGIRON_coilsOff_z_cbaredit.pdf}
  \caption{The z-component of the magnetic field with two layers of GIRON flooring}
  \label{fig:bfield_2gironeffects}
  \end{center}
\end{figure}
%
